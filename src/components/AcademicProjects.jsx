          ...
          {projects.map((proj, idx) => {
            ...
            return (
              <motion.div
                key={idx}
                variants={fadeInUp}
                className="group relative backdrop-blur-sm rounded-2xl p-6 transition-all duration-300 overflow-hidden cursor-default"
              ...
              >
                ...
                <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-violet-500/5 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
