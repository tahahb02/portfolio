...
export default function Footer({ name }) {
  ...
  return (
    <footer className="py-12 px-6 relative" style={{ borderTop: "1px solid var(--border-color)" }}>
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: "var(--text-muted)" }}>
              <li className="flex items-center gap-2 hover:text-slate-400 transition-colors cursor-default">
                <FaMapMarkerAlt className="text-xs text-violet-400/60" />
                Casablanca, Maroc
              </li>
              <li className="flex items-center gap-2 hover:text-slate-400 transition-colors cursor-default">
                <FaPhoneAlt className="text-xs text-cyan-400/60" />
                +212-691436399
              </li>
              <li className="flex items-center gap-2 hover:text-slate-400 transition-colors cursor-default">
                <FaEnvelope className="text-xs text-amber-400/60" />
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-3 flex items-center gap-2" style={{ color: "var(--text-secondary)" }}>
              <span className="w-1 h-4 bg-gradient-to-b from-cyan-500 to-violet-500 rounded-full" />
              {t.contact.infoTitle === "Contact Information" ? "Social" : "Réseaux"}
            </h4>
            <div className="flex gap-3">
              {[
                { icon: FaGithub, href: "https://github.com/tahahb02", hover: "hover:text-violet-400", shadow: "hover:shadow-violet-500/20" },
                { icon: FaLinkedin, href: "https://linkedin.com/in/taha-hilalbik", hover: "hover:text-cyan-400", shadow: "hover:shadow-cyan-500/20" },
                { icon: FaEnvelope, href: "mailto:hilalbiktaha@gmail.com", hover: "hover:text-amber-400", shadow: "hover:shadow-amber-500/20" },
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 p-3 bg-gradient-to-r from-violet-600 to-cyan-600 text-white rounded-xl shadow-lg shadow-violet-500/25 hover:shadow-xl hover:shadow-violet-500/40 hover:scale-110 active:scale-90 transition-all duration-300 cursor-pointer z-40"
