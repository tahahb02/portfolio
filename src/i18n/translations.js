...
export const translations = {
  fr: {
    ...
    footer: { madeWith: "Fait avec", in: "au Maroc", social: "Réseaux" },
  ...
  en: {
    ...
    footer: { madeWith: "Made with", in: "in Morocco", social: "Social" },
  ...
  de: {
    ...
    projects: { title: "Akademische Projekte" },
    ...
    footer: { madeWith: "Gemacht mit", in: "in Marokko", social: "Sozial" },
